...
class Producto(models.Model):
    ...
    nombre = models.TextField(null=False, max_length=50,verbose_name="Nombre de Producto")
    ...
    fechaVencimiento = models.DateField(null=False,verbose_name="Vencimiento de Garantía")
...
class Contacto(models.Model):
    ...
    email = models.EmailField(null=False, max_length=50,verbose_name="Correo Electrónico")
